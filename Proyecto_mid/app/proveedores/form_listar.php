...
<head>
  ...
  <title>Módulo de Listado de Proveedor</title>
...
<body>
  <div class="container mt-5">
    <h2 class="list-header">Módulo de Listado de Proveedores</h2>

    <!-- Barra de búsqueda -->
    <form action="" method="get" autocomplete="off">
      <div class="input-group mb-4">
        <input type="text" class="form-control" placeholder="Ingrese una proveedor a buscar" name="buscar" id="buscar" onkeyup="generar_datagrid();"
          aria-label="Buscar Proveedor" aria-describedby="button-buscar" value="">
    ...
    <div class="mb-4 text-end">
      <button class="btn btn-agregar" data-bs-toggle="modal" data-bs-target="#modalAgregarProveedor"><i
          class="fas fa-plus-circle"></i> Agregar Proveedor</button>
    </div>
...
<script>
  ...
  function generar_datagrid() {
    ...
    xhr.onload = function() {
      if (xhr.status === 200) {
        ...
        div_response.innerHTML = xhr.responseText; // Inserta el contenido de listado_proveedores.php en el div_datagrid
      } else {
  ...
  function limpiarBusqueda() {
    ...
    generar_datagrid(); // Volver a cargar todos las proveedores
  }
</script>
<script>
  function limpiarbusqueda() {
