...
<body>
  <div class="container-fluid" style="padding-top: 10px;">
    <form name="form_editar" action="./proc_actualizar.php?idcl=<?php echo $_GET['idpv']; ?>" method="post" autocomplete="off">
      ...
      <div class="card text-dark bg-light mb-3 card-shadow">
        <div class="card-header"><center>Edición de Proveedores</center></div>
        <div class="card-body">

          <div class="row mb-3">
            <label for="nombre" class="col-2 col-form-label">Nombre Completo:</label>
            <div class="col-10">
              <input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo $dt_proveedor[0]["nombre"]; ?>">
            </div>
          </div>
          <div class="row mb-3">
  ...
  function validar_nuevo() {
    if (!document.getElementById('nombre').value) {
      ...
      Swal.fire({
        position: 'center',
        icon: 'warning',
        title: 'Ingrese la dirección del proveedor',
        showConfirmButton: true,
        timer: 3000
      })
    } else {
