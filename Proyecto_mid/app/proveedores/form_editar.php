...
<head>
  ...
  <title>Ferretería - Módulo editar de Proveedores</title>
...
<body>
  <div class="container mt-5">
    <form name="form_nuevo" action="./proc_editar.php?id=<?php echo $id ?>" method="post" autocomplete="off">
      ...
      <div class="card card-custom p-4">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" class="form-control" id="nombre" value="<?php echo $nombre ?>" name="nombre" placeholder="Nombre Completo" required>
                <label for="nombre"><i class="bi bi-person-fill me-2"></i>Nombre Completo</label>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" class="form-control" id="tipo_proveedor"  value="<?php echo $tipo_proveedor ?>" name="tipo_proveedor" placeholder="Tipo de Proveedor" required>
        ...
        <div class="form-section highlight">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <div class="form-floating">
                <input type="tel" class="form-control" id="telefono" value="<?php echo $telefono ?>" name="telefono" placeholder="Teléfono" required pattern="^[0-9]{8}$">
        ...
        <div class="form-section">
          ...
          <div class="row g-3">
            <div class="col-md-4">
              <div class="form-floating">
                <input type="text" class="form-control" id="dui" value="<?php echo $dui ?>" name="dui" placeholder="DUI" required maxlength="10">
                <label for="dui"><i class="bi bi-credit-card-2-front-fill me-2"></i>DUI</label>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-floating">
                <input type="text" class="form-control" id="nit" value="<?php echo $nit ?>" name="nit" placeholder="NIT" required maxlength="17">
                <label for="nit"><i class="bi bi-file-earmark-text-fill me-2"></i>NIT</label>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-floating">
                <input type="text" class="form-control" value="<?php echo $nrc ?>" id="nrc" name="nrc" placeholder="NRC" required maxlength="10">
        ...
        <div class="form-section highlight">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" class="form-control" id="giro" value="<?php echo $giro ?>" name="giro" placeholder="Giro" maxlength="50">
