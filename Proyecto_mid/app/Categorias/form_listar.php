...
<head>
  ...
  <title>Módulo de Listado de Categorías</title>
...
<body>
  <div class="container mt-5">
    <h2 class="list-header">Módulo de Listado de Categorías</h2>
    ...
    <div class="mb-4 text-end">
      <button class="btn btn-agregar" data-bs-toggle="modal" data-bs-target="#modalAgregarCategoria"><i
