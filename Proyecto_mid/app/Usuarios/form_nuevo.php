...
<head>
  ...
  <title>Ferretería - Módulo de Usuario</title>
...
<body>
  <div class="container mt-5">
    <form name="form_usuario" action="./proc_agregar.php" method="post" autocomplete="off">
      <div class="d-flex align-items-center mb-4">
        <h1 class="fw-bold" style="font-size: 28px; color: #495057; border-bottom: 2px solid #495057;">Módulo de agregar Usuario</h1>
        <div class="ms-auto">
