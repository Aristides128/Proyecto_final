...
<head>
  ...
  <title>Ferretería - Módulo de editar Usuario</title>
      ...
      <div class="card card-custom p-4">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" class="form-control" value="<?php echo $nombre_completo ?>" id="nombre_completo" name="nombre_completo" placeholder="Nombre Completo" required>
                <label for="nombre_completo"><i class="bi bi-person me-2"></i>Nombre Completo</label>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" class="form-control" value="<?php echo $usuario ?>" id="usuario" name="usuario" placeholder="Nombre de Usuario" required>
        ...
        <div class="form-section">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="form-floating">
                <input type="password" value="<?php echo $contrasena ?>" class="form-control" id="contrasena" name="contrasena" placeholder="Contraseña" required>
