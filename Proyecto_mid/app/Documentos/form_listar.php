    ...
    <div class="container mt-5">
      ...
      <form action="" method="get" autocomplete="off">
        <div class="input-group mb-4">
          <input type="text" class="form-control" placeholder="Ingrese un documento a buscar" name="buscar" id="buscar" onkeyup="generar_datagrid();"
            aria-label="Buscar Documentos" aria-describedby="button-buscar" value="<?php echo @$_GET['buscar'] ?>">
