...
$tipo_cliente = @$dt_cliente[0]['tipo_cliente'];
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
  ...
  <title>Formulario detalles personas naturales</title>
    ...
    <div class="card card-custom p-4">
        ...
        <div class="row g-3">
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre Completo" value="<?php echo $nombre ?>" required disabled>
      ...
      <div class="form-section highlight">
        ...
        <div class="row g-3">
          <div class="col-md-6">
            <div class="form-floating">
              <textarea class="form-control" id="direccion" name="direccion" placeholder="Dirección" style="height: 100px;" disabled required><?php echo $direccion ?></textarea>
              <label for="direccion"><i class="bi bi-geo-alt-fill me-2"></i>Dirección</label>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-floating">
              <select class="form-control" disabled value="<?php echo $estado_civil ?>" id="estado_civil" name="estado_civil" required>
                <option disabled selected>Seleccione</option>
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="tel" class="form-control" disabled id="telefono" name="telefono" placeholder="Teléfono" required pattern="^[0-9]{8}$" value="<?php echo $telefono ?>">
      ...
      <div class="form-section">
        ...
        <div class="row g-3">
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" id="dui" disabled name="dui" placeholder="DUI" required maxlength="10" value="<?php echo $dui ?>">
        ...
        <div class="row g-3">
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" id="tipo_cliente" disabled name="tipo_cliente" placeholder="tipo_cliente" required value="<?php echo $tipo_cliente  ?>">
              <label for="tipo_cliente"><i class="bi bi-credit-card-2-front-fill me-2"></i>DUI</label>
            </div>
          </div>
        </div>
      </div>
