...
$query = "SELECT * FROM tbl_clientes WHERE tipo_cliente = 'Consumidor final'";
    ...
    <?php foreach ($paginador->registros_pagina as $Clientes): ?>
      ...
      <tr style="text-align: left;">
        ...
        <td class="text-right" style="text-align: right;">
          <a href="./form_detalles_consumidor_final.php?id=<?php echo $Clientes['id_cliente'] ?>">
          ...
          <a href="./form_editar_consumidor_final.php?id=<?php echo $Clientes['id_cliente'] ?>">
