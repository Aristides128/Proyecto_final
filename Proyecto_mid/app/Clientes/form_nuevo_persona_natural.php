...
<head>
  ...
  <title>Formulario agregar personas naturales</title>
...
<body>
  <div class="container mt-5">
    <form name="form_nuevo" action="./proc_agregar_persona_natural.php" method="post" autocomplete="off">
      <div class="d-flex align-items-center mb-4">
        <h1 class="fw-bold" style="font-size: 28px; color: #495057; border-bottom: 2px solid #495057;">Módulo De Personas Naturales</h1>
        <div class="ms-auto">
