...
<head>
  ...
  <title>Formulario detalles Consumidores finales</title>
...
<body>
  <div class="container mt-5">
    <div class="d-flex align-items-center mb-4">
      <h1 class="fw-bold" style="font-size: 28px; color: #495057; border-bottom: 2px solid #495057;">Módulo De edicion Consumidores finales</h1>
      <div class="ms-auto">
    ...
    <div class="card card-custom p-4">
        ...
        <div class="row g-3">
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" id="nombre" disabled name="nombre" placeholder="Nombre Completo" value="<?php echo $nombre ?>" required>
              <label for="nombre"><i class="bi bi-person-fill me-2"></i>Nombre Completo</label>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-floating">
              <select class="form-control" id="genero" disabled name="genero" required>
      ...
      <div class="form-section highlight">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <select class="form-control" id="estado_civil" disabled name="estado_civil" value="<?php echo $estado_civil ?>" required>
                <option disabled selected>Seleccione</option>
      ...
      <div class="form-section">
        ...
        <div class="row g-3">
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" id="dui" name="dui" disabled placeholder="DUI" required maxlength="10">
