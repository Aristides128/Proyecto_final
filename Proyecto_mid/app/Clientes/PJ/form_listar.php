  ...
  <div class="container mt-5">
    ...
    <form action="" method="get" autocomplete="off">
      <div class="input-group mb-4">
        <input type="text" class="form-control" placeholder="Ingrese un cliente a buscar" name="buscar" id="buscar" onkeyup="generar_datagrid();"
    ...
    <div class="mb-4 text-end">
      <a href="./form_nuevo.php"><button class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#modalAgregarCliente"><i
          class="fas fa-plus-circle"></i> Agregar Cliente</button></a>
    </div>
