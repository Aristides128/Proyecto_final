      ...
      <div class="card text-dark bg-light mb-3 card-shadow">
        ...
        <div class="card-body">
          ...
          <div class="row mb-3">
            ...
            <div class="col-10">
              <textarea class="form-control" name="direccion" id="direccion" readonly><?php echo $dt_cliente[0]["direccion"]; ?></textarea>
            </div>
          </div>
          ...
          <div class="row mb-3">
            <label for="fecha_registro" class="col-2 col-form-label">Fecha de Registro:</label>
            <div class="col-10">
              <input type="text" class="form-control" name="fecha_registro" id="fecha_registro" value="<?php echo $dt_cliente[0]["fecha_registro"]; ?>">
            </div>
          </div>
