...
<head>
  ...
  <title>Módulo de Listado de Clientes</title>
...
<body>
  <div class="container mt-5">
    <h2 class="list-header">Módulo de Listado de Clientes</h2>

    <!-- Barra de búsqueda -->
    <form action="" method="get" autocomplete="off">
      <div class="input-group mb-4">
        <input type="text" class="form-control" placeholder="Ingrese una cliente a buscar" name="buscar" id="buscar" onkeyup="generar_datagrid();"
    ...
    <div class="mb-4 text-end">
      <button class="btn btn-agregar" data-bs-toggle="modal" data-bs-target="#modalAgregarCliente"><i
          class="fas fa-plus-circle"></i> Agregar Cliente</button>
    </div>
...
<script>
    ...
    function generar_datagrid() {
      ...
      xhr.open("GET", "./listado_clientes.php?buscar=" + buscar + "&pa=" + pagina, true); // Incluir número de página
      xhr.onload = function() {
        if (xhr.status === 200) {
