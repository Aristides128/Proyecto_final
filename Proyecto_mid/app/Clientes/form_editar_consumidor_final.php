...
<head>
  ...
  <title>Formulario editar Consumidores finales</title>
...
<body>
  <div class="container mt-5">
    <form name="form_nuevo" action="./proc_editar_consumidor_final.php?id= <?php echo $id ?>" method="post" autocomplete="off">
      ...
      <div class="card card-custom p-4">
        ...
        <div class="form-section highlight">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <div class="form-floating">
                <select class="form-control" id="estado_civil" name="estado_civil" value="<?php echo $estado_civil ?>" required>
                  <option disabled selected>Seleccione</option>
