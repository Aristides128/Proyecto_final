...
<head>
  ...
  <title>Formulario editar personas Juridicas</title>
...
<body>
  <div class="container mt-5">
    <form name="form_nuevo" action="./proc_editar_persona_juridica.php?id=<?php echo $id ?>" method="post" autocomplete="off">
      ...
      <div class="card card-custom p-4">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" class="form-control" value="<?php echo $nombre ?>" id="nombre" name="nombre" placeholder="Nombre Completo" required>
        ...
        <div class="form-section highlight">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="form-floating">
                <textarea class="form-control" id="direccion" name="direccion" placeholder="Dirección" style="height: 100px;" value="" required><?php echo $direccion ?></textarea>
                <label for="direccion"><i class="bi bi-geo-alt-fill me-2"></i>Dirección</label>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-floating">
                <input type="tel" class="form-control" id="telefono" name="telefono" placeholder="Teléfono" value="<?php echo $telefono ?>" required pattern="^[0-9]{8}$">
        ...
        <div class="form-section">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" class="form-control" id="nit" name="nit" placeholder="NIT" value="<?php echo $nit ?>" required maxlength="17">
                <label for="nit"><i class="bi bi-file-earmark-text-fill me-2"></i>NIT</label>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" class="form-control" id="nrc" name="nrc" placeholder="NRC" value="<?php echo $nrc ?>" required>
                <label for="nrc"><i class="bi bi-briefcase-fill me-2"></i>NRC</label>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" class="form-control" id="giro" name="giro" placeholder="Giro" value="<?php echo $giro ?>" required>
