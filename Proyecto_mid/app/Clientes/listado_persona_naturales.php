...
$query = "SELECT * FROM tbl_clientes WHERE tipo_cliente = 'Persona natural'";
    ...
    <?php foreach ($paginador->registros_pagina as $Clientes): ?>
      ...
      <tr style="text-align: left;">
        ...
        <td class="text-right" style="text-align: right;">
          <a href="./form_detalles_persona_natural.php?id=<?php echo $Clientes['id_cliente'] ?>">
          ...
          <a href="./form_editar_persona_natural.php?id=<?php echo $Clientes['id_cliente'] ?>">
            <button class="btn btn-s btn-outline-success btn-action" data-bs-toggle="tooltip"
              title="Editar este Cliente">
              <i class="fas fa-edit"></i> Editar
            </button>
          </a>
          <button class="btn btn-s btn-outline-danger btn-action" data-bs-toggle="tooltip" onclick="eliminar(<?php echo $Clientes['id_cliente'] ?>)"
