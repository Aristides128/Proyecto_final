...
<body>
  ...
  <section class="home-section">
    <div class="container mt-5">
      <h2 class="list-header">Listado de Servicios</h2>

      <!-- Barra de búsqueda -->
      <form action="" method="get" autocomplete="off">
        <div class="input-group mb-4">
          <input type="text" class="form-control" placeholder="Ingrese un servicio a buscar" name="buscar" id="buscar" onkeyup="generar_datagrid();"
      ...
      <div class="mb-4 text-end">
        <a href="./form_nuevo.php"><button class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#modalAgregarServicio"><i
              class="fas fa-plus-circle"></i> Agregar Servicio</button></a>
      </div>
    ...
    <script>
      ...
      function generar_datagrid() {
        ...
        xhr.open("GET", "./listado_servicios.php?buscar=" + buscar + "&pa=" + pagina, true); // Incluir número de página
        xhr.onload = function() {
          if (xhr.status === 200) {
      ...
      function eliminar(id_servicio) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            window.location.href = `./proc_eliminar.php?id=${encodeURIComponent(id_servicio)}`;;
          }
        });
      }
    </script>
