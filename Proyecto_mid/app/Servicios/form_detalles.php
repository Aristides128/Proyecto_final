...
<body>
  <div class="container mt-5">
    <form name="form_nuevo" action="./proc_editar.php" method="post" autocomplete="off">
      ...
      <div class="card card-custom p-4">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" class="form-control" disabled id="nombre" value="<?php echo $nombre ?>" name="nombre" placeholder="Nombre del servicio" required>
        ...
        <div class="form-section highlight">
          ...
          <div class="row g-3">
            <div class="col-md-4">
              <div class="form-floating">
                <input type="number" class="form-control" disabled id="precio_venta1" value="<?php echo $precio_venta1 ?>" name="precio_venta1" placeholder="Precio de Venta 1" required>
                <label for="precio_venta1"><i class="bi bi-currency-dollar me-2"></i>Precio de Venta 1</label>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-floating">
                <input type="number" class="form-control" disabled id="precio_venta2" value="<?php echo $precio_venta2 ?>" name="precio_venta2" placeholder="Precio de Venta 2" required>
                <label for="precio_venta2"><i class="bi bi-currency-dollar me-2"></i>Precio de Venta 2</label>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-floating">
                <input type="number" class="form-control" disabled value="<?php echo $precio_venta3 ?>" id="precio_venta3" name="precio_venta3" placeholder="Precio de Venta 3" required>
